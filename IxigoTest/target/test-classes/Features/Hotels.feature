Feature: Ixigo Hotels Module
  ...
  #Scenario: User opens ixigo site and navigates to Hotels section
    ...
    @log2
Scenario: User fills the hotel search form and clicks Search
...
#Examples:
  ...
  #@log3
#Scenario: User changes sort option from the Popularity dropdown
  ...
  #@log4
#Scenario: User searches within Goa using area suggestion
  #Given user is on the hotel search results page
  #When user clicks on the "Search within Goa" field
