...
import com.pages.FilterDataPage;
import com.pages.FlightNegativeDataPage;
import com.pages.PartialTextDataPage;
...
public class FlightTest {
	...
	PartialTextDataPage partialpage;
	FilterDataPage fd;
...
//------------------------------------Scenario 1------------------------------------------------------------------	
	/* created by:Gauravi Kulkarni
	 * Reviewed By:
	 * Motive: Search one-way flight with valid details
	 *
	 * *
	 */
	...
	@When("User enters city in the From field")
	public void user_enters_city_in_the_from_field() {
		pg.fromData();

	}

	@When("User enters city in the To field")
	public void user_enters_city_in_the_to_field() {
		pg.ToData();
...
//------------------------------------Scenario 2------------------------------------------------------------------
	...
	/* created by:Gauravi Kulkarni
	 * Reviewed By:
	 * Motive: Search round-trip flight with valid details
	 *
	 * *
	 */
...
//------------------------------------Scenario 3------------------------------------------------------------------
	/* created by:Gauravi Kulkarni
	 * Reviewed By:
	 * Motive:  Validate error when same city is entered in From and To field
	 *
	 * *
	 */
	...
	public void user_enters_same_city_in_to_field() throws InterruptedException, AWTException {
		nf.ToSameCity();
	}
	...
	public void user_should_see_error_message() throws TimeoutException {
		nf.CheckAssert();
...
//------------------------------------Scenario 4------------------------------------------------------------------
	/* created by:Gauravi Kulkarni
	 * Reviewed By:
	 * Motive: User applies airline filter
	 *
	 * *
	 */
	...
	@When("User clicks on airline filter")
	public void user_clicks_on_airline_filter() throws InterruptedException {
		fd.filter();
...
//------------------------------------Scenario 5------------------------------------------------------------------
	/* created by:Gauravi Kulkarni
	 * Reviewed By:
	 * Motive: Validate partial text in From and To fields should show suggestions
	 *
	 * *
	 */
	@When("the user enters partial city name in From field and To field")
	public void the_user_enters_partial_city_name_in_from_field_and_to_field() {
		pg = new BasePage(driver);
		partialpage = new PartialTextDataPage(driver);
		partialpage.enterPartialText();

	}

	@Then("the From field should contain city name")
	public void the_from_field_should_contain_city_name1() {

	}

	@Then("the To field should contain city name")
	public void the_to_field_should_contain_city_name1() {

	}

	@AfterStep
	public void tearDown(Scenario scenario) {
		// Use the shared driver instance from BaseSteps
		...
		if (driver != null) {
			try {
				...
				// Create screenshot file for external reference
				File screenshotFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				String scenarioName = scenario.getName().replaceAll("[^a-zA-Z0-9]", "_");
				String fileName = "screenshots/" + scenarioName + "_" + System.currentTimeMillis() + ".png";
